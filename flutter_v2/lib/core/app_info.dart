abstract final class AppInfo {
  ...
  static const version = '2.6.0+15';
  static const developerName = 'عوض بن قفله';

  // Temporary public project link. Replace with the final stable APK
  // release URL when Flutter V2 becomes the production application.
